    ...
    class Token
    {
        ...
        void Message_received_completed(object send, SocketAsyncEventArgs e)
        {
            try
            {
                ...
                if (bytesReceived > 0 && e.SocketError == SocketError.Success)
                {
                    ...
                    if (received_message.pt_id == PROTOCOL.Deliver_Message) Console.WriteLine(received_message.send_message);
        ...
        void SendLoop(int room_num)
        {
            ...
            while (true)
            {
                ...
                string data_add_ID = client_ID + " >> " + message;
                ...
                new_send_message.send_message = data_add_ID;
